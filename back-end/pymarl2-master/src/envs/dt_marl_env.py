...
class Setting():
    def __init__(self):
        ...
        self.fixed_start_location = np.array([[random.uniform(MIN_X, MAX_X), random.uniform(MIN_Y, MAX_Y)] for _ in range(self.num_ue)])
        self.UserLocation = np.copy(self.fixed_start_location)
